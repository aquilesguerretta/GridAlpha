...
export default function GenerationMix() {
  ...
  // Group by timestamp and pivot fuel_type rows into columns
  ...
  // Only sum generation fuel types — exclude temperature, load_forecast, load_actual
  const totalGeneration =
	currentGeneration.nuclear +
	currentGeneration.gas +
	currentGeneration.coal +
	currentGeneration.wind +
	currentGeneration.solar +
	currentGeneration.hydro +
    ...
    <div className="p-4 bg-muted/50 border border-border rounded-lg flex items-center gap-3">
      ...
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Connect to PJM API when credentials are available. Displaying simulated generation data.
        </p>
      </div>
    </div>
  )}
